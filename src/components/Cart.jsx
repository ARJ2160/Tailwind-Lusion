...
const Cart = ({ cartIsOpen, cartToggle, clearCart }) => {
  const makePayment = async (token) => {
    ...
    return await axios
      .post('https://localhost:5000/payment', {
        method: 'POST',
        headers,
  ...
  const { cart, amount, total, increase, decrease, remove } =
    useGlobalContext();
  ...
  return (
    <div className={cartIsOpen ? 'cart_toggle' : 'hidden'}>
      <div className='cart-items-list bg-white'>
        <div
          className='cart-close flex justify-between items-center h-24 p-5 bg-white'
          onClick={cartToggle}>
                  ...
                  <div className='cart-items flex'>
                    ...
                    <div className='flex flex-col w-full sm:p-5 p-2'>
                      ...
                      <div className='product-amount-price flex justify-between items-center'>
                        ...
                        <div className='product-price text-gray-500'>
                          $ {price}
                        </div>
                      </div>
                    </div>
      ...
      <div>
        ...
        <div className='checkout-btn p-5 flex flex-col justify-between items-center'>
          ...
          <button className='w-full border bg-white py-5 text-xl'>
            View Cart
          </button>
        </div>
      </div>
