                ...
                <div className='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
                  ...
                  <div className='grid grid-cols-3 gap-8 py-5 items-center'>
                    <div className='product-amount col-span-1 flex justify-around items-center border-2 border-black'>
                      ...
                      <div className='amount col-span-1 text-xl px-4'>
                        {productAmount}
                      </div>
                    ...
                    <div className='add-btn col-span-1'>
                      <div
                        className='flex justify-center text-center min-w-max bg-black text-white items-center py-5 px-10 cursor-pointer'
                        onClick={() => getTotals(id)}>
                        ADD TO CART
                      </div>
                    </div>
